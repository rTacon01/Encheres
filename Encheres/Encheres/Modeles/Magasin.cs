...
namespace Encheres.Modeles
{
    public class Magasin
    {
        ...
        public Magasin(int id, string nom, string adresse, string ville, int code_postal, string portable, double latitude, ObservableCollection<Produit> lesProduits, double logitude)
        {
